...
execute if score @s pir.str_island.bb matches 1 run setblock ~-5 ~1 ~-5 structure_block{name:"pirates:ships/traders/traders1",posX:0,posY:0,posZ:0,mode:"LOAD"}
execute if score @s pir.str_island.bb matches 2 run setblock ~-5 ~1 ~-5 structure_block{name:"pirates:ships/traders/traders2",posX:0,posY:0,posZ:0,mode:"LOAD"}
