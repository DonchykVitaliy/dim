...
#moments
execute unless entity @s[tag=pir.reload,tag=pir.animation_move,tag=pir.attack_animation_2,tag=pir.attack_animation_3] unless entity @a[distance=..6,gamemode=!creative,gamemode=!spectator] as @e[type=item_display,tag=pir.boss.mob,limit=1,sort=nearest,tag=!pir.damage_animation,tag=!pir.animation_move,tag=!pir.animation_moment] run function pirates:mobs/work/boss/moment_main
execute unless entity @s[tag=pir.reload,tag=pir.animation_move,tag=pir.attack_animation_2,tag=pir.attack_animation_3] as @e[type=item_display,tag=pir.boss.mob,limit=1,sort=nearest,tag=pir.animation_moment] run function pirates:mobs/work/boss/moment_loop
execute if entity @s[tag=pir.animation_move] as @e[type=item_display,tag=pir.boss.mob,limit=1,sort=nearest,tag=pir.animation_moment] run function pirates:mobs/work/boss/moment_stop
